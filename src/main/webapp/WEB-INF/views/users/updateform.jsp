...
<head>
<meta charset="UTF-8">
<title>/views/users/updatedform.jsp</title>
<style>
	#imageForm{
		display: none;
	}
...
<body>
	<div class="container">
		...
		<form id="imageForm" action="${pageContext.request.contextPath }/users/profile_upload" method="post" enctype="multipart/form-data">
			<!-- servlet-context에 Multipart 폼 전송을 위한 bean 설정을 해줘야함 -->
			프로필 사진
				...
				.then(function(response){
					...
					.then(function(data){
						...
						let img = `<img id="profileImage"
							...
							//id가 profileLink인 요소의 내부(자식요소)에 덮어쓰기 하면서 html 형식으로 해석해 주세요 라는 의미
